 ...
 *     to drive UE movements using its mobility model (line 543-573, 400-403)
 *  ➢ Handover algorithm set to A3RsrpHandoverAlgorithm with specific parameters (line 333-337)
 *  ➢ ListPositionAllocator used to set the correct base station positions for the given 4-cell
 *     scenario (line 367-390)
 *  ➢ Added trace sink and source to trigger extraction of network measurements from periodic UE 
 *     measurement reports, using a bound callback (line 243-273, 536-538)
...
main (int argc, char *argv[])
{
  ...
  // Arrangement A
  // Vector enbPosition3 (925, 180, 0);
  // enbPositionAlloc->Add (enbPosition3);
  // Vector enbPosition4 (550, 300, 0);
  // enbPositionAlloc->Add (enbPosition4);

  // Arrangement B
  // Vector enbPosition3 (675, 300, 0);
  // enbPositionAlloc->Add (enbPosition3);
  // Vector enbPosition4 (800, 180, 0);
  // enbPositionAlloc->Add (enbPosition4);

  // Arrangement C
  Vector enbPosition3 (675, 260, 0);
  enbPositionAlloc->Add (enbPosition3);
  Vector enbPosition4 (800, 220, 0);
  enbPositionAlloc->Add (enbPosition4);
